...
const createVideo = async (req, res) => {
    try {
        ...
        const video = new VideoModel({
            name,
            url,
            playlist: "General" // Asocia automáticamente al Playlist General
        });
...
const getVideos = async (req, res) => {
    try {
        ...
        // Convertir las URL directas de YouTube a URL embebidas
...
// Función para convertir una URL directa de YouTube a una URL embebida
function convertToEmbeddedURL(url) {
    // Aquí asumimos que las URL directas de YouTube tienen el formato 'https://www.youtube.com/watch?v=VIDEO_ID'
...
const updateVideo = async (req, res) => {
    try {
        ...
        const updatedVideo = await VideoModel.findByIdAndUpdate(id, { name, url }, { new: true });
